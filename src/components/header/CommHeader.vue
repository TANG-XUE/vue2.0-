<template>
  <div class="header">
    <div class="content-wrapper">
      <div class="avatar">
        <img width="64" height="64" :src="this.seller.avatar" alt="">
      </div>
      <div class="content">
        <div class="title">
        ...
        <div v-if="this.seller.supports" class="support">
          <span class="icon" :class="classMap[this.seller.supports[0].type]"></span>
          <span class="text">{{this.seller.supports[0].description}}</span>
        </div>
      </div>
      <div v-if="this.seller.supports" class="support-count">
        <span class="count">{{this.seller.supports.length}}个</span>
        <i class="icon-keyboard_arrow_right"></i>
      </div>
    </div>
    <div class="bulletin-wrapper" @click="showDetail">
      <span class="bulletin-title"></span><span class="bulletin-text">{{this.seller.bulletin}}</span>
      <i class="icon-keyboard_arrow_right"></i>
    </div>
        ...
        <div class="detail-wrapper clearfix">
          <div class="detail-main">
            ...
            <ul v-if="this.seller.supports" class="supports">
              <li class="support-item" v-for="(item,index) in this.seller.supports" :key="index">
