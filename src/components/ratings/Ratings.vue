<template>
    <div class="ratings" ref="ratings">
        <div class="ratings-content">
          ...
          <split></split>
          <rating-select @increment="incrementTotal" :select-type="selectType" :only-content="onlyContent" :ratings="ratingsList"></rating-select>
...
<script>
  ...
  const ERR_OK = 0;
    ...
    export default {
      ...
      data() {
          return {
            ratingsList: this.$store.state.ratings,
            selectType: ALL,
            onlyContent: true
          }
      },
